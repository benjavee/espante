            ...
            <main className="pt-24 flex flex-col">
                ...
                <section id="mentions-legales" className="max-w-5xl mx-auto px-4 py-8">
                    ...
                    <div className="mt-4 space-y-4 text-gray-700">
                        <p>Le site <strong>www.espanté.fr</strong> est édité par <strong>Kevyn Goutanier</strong>,
                            artiste indépendant, auteur de la bande dessinée « Espanté », une œuvre auto‑éditée,
                            imprimée en France, disponible exclusivement en précommande via ce site.</p>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <dd className="space-x-2">
                                    <a href="mailto:lagoutanerie@gmail.com"
                                       className="underline underline-offset-4 hover:no-underline">lagoutanerie@gmail.com</a>
                                    <span>•</span>
                                    <a href="https://www.instagram.com/lagoutanerie" target="_blank"
                                       rel="noopener noreferrer"
                                       className="underline underline-offset-4 hover:no-underline">Instagram
                                        @Lagoutanerie</a>
                                </dd>
                            </div>
                        </dl>
                        <div>
                            ...
                            <address className="not-italic mt-2">
                                ...
                                <div>Site web : <a href="https://www.gandi.net/" target="_blank"
                                                   rel="noopener noreferrer"
                                                   className="underline underline-offset-4 hover:no-underline">www.gandi.net</a>
                                </div>
                            </address>
                        </div>
                    </div>
                ...
                <section id="cgv" className="max-w-5xl mx-auto px-4 py-8">
                    ...
                    <div className="mt-4 space-y-6 text-gray-700">
                        <p>Les présentes conditions régissent les relations contractuelles entre Kevyn Goutanier (SIREN
                            803&nbsp;356&nbsp;997) et toute personne souhaitant effectuer une précommande
                            sur <strong>www.espanté.fr</strong>.</p>

                        <div>
                            <h3 className="font-semibold">1. Objet</h3>
                            <p>Le site propose la précommande de l’œuvre « Espanté » via différents packs. Les ventes
                                sont ouvertes exclusivement en ligne et dans la limite des stocks disponibles.</p>
                        </div>

                        <div>
                            <h3 className="font-semibold">2. Produits proposés</h3>
                            <p>Les produits sont proposés sous forme de packs (description, contenu et prix affichés sur
                                le site). Les visuels et descriptions sont fournis à titre indicatif et peuvent évoluer
                                lors de la production finale.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>Produits vendus en précommande, livraison estimée à l’automne 2025 (sous réserve de
                                    production).
                                </li>
                                <li>Information par e‑mail sur l’avancement et l’expédition.</li>
                                <li>Frais de port : indiqués lors de la commande (inclus ou en supplément selon le
                                    pack).
                                </li>
                                <li>Zone de livraison : France métropolitaine (autres zones si précisées sur le site).
                                </li>
                        ...
                        <div>
                            ...
                            <p>Conformément à l’article L221‑28 du Code de la consommation, les précommandes de biens
                                personnalisés ou produits à la demande (ex. exemplaires signés/limités) ne donnent pas
                                lieu à un droit de rétractation après paiement. Toute demande d’annulation sera examinée
                                au cas par cas avant impression. Après lancement de production, aucun remboursement
                                n’est dû, sauf indisponibilité du produit.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>Les données collectées sont utilisées pour la gestion des précommandes, la livraison et
                                la communication liée au projet. Voir la <Link href="#politique-de-confidentialite"><a
                                    className="underline underline-offset-4 hover:no-underline">Politique de
                                    confidentialité</a></Link>.</p>
                        </div>

                        <div>
                            <h3 className="font-semibold">9. Propriété intellectuelle</h3>
                            <p>L’œuvre « Espanté » et les éléments du site (textes, images, illustrations, logo) sont
                                protégés par le droit d’auteur. Toute reproduction ou diffusion non autorisée est
                                interdite.</p>
                        </div>

                        <div>
                            <h3 className="font-semibold">10. Loi applicable et litiges</h3>
                            <p>Les CGV sont soumises au droit français. En cas de litige, une solution amiable sera
                                recherchée ; à défaut, les tribunaux français seront compétents.</p>
                        </div>
                    </div>
                </section>
                ...
                <section id="politique-de-confidentialite" className="max-w-5xl mx-auto px-4 py-8">
                    ...
                    <div className="mt-4 space-y-6 text-gray-700">
                        <div>
                            ...
                            <p>Kevyn Goutanier – Artiste indépendant (SIREN 803&nbsp;356&nbsp;997). Contact : <a
                                href="mailto:lagoutanerie@gmail.com"
                                className="underline underline-offset-4 hover:no-underline">lagoutanerie@gmail.com</a> –
                                Instagram : <a href="https://www.instagram.com/lagoutanerie" target="_blank"
                                               rel="noopener noreferrer"
                                               className="underline underline-offset-4 hover:no-underline">@Lagoutanerie</a>.
                            </p>
                        </div>
                        <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li>Informations de paiement (via Stripe, de manière sécurisée) – aucune donnée bancaire
                        ...
                        <div>
                            ...
                            <p className="mt-2">Pour exercer vos droits : <a href="mailto:lagoutanerie@gmail.com"
                                                                             className="underline underline-offset-4 hover:no-underline">lagoutanerie@gmail.com</a>.
                                Vous pouvez saisir la CNIL (<a href="https://www.cnil.fr/" target="_blank"
                                                               rel="noopener noreferrer"
                                                               className="underline underline-offset-4 hover:no-underline">www.cnil.fr</a>).
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold">8. Cookies</h3>
                            <p>Voir la <Link href="#cookies"><a
                                className="underline underline-offset-4 hover:no-underline">Politique de gestion des
                                cookies</a></Link>.</p>
                        </div>
                    </div>
                </section>
                ...
                <section id="cookies" className="max-w-5xl mx-auto px-4 py-8">
                    ...
                    <div className="mt-4 space-y-6 text-gray-700">
                        <div>
                            ...
                            <p>Petit fichier texte déposé sur votre appareil (ordinateur, tablette, mobile) lors de la
                                visite d’un site web. Il stocke temporairement des informations de navigation.</p>
                        </div>
                        <div>
                            ...
                            <p className="mt-2">Ces cookies sont désactivés par défaut et ne sont activés qu’avec votre
                                accord.</p>
                        </div>
                        <div>
                            <h3 className="font-semibold">3. Gestion du consentement</h3>
                            <p>Lors de la première visite, un bandeau permet d’accepter, refuser ou personnaliser les
                                cookies non essentiels. Vous pouvez modifier vos choix à tout moment via le lien «
                                Gestion des cookies » en pied de page.</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p>Vous pouvez retirer votre consentement à tout moment et demander l’accès, la modification
                                ou la suppression des données collectées via ces cookies. Contact : <a
                                    href="mailto:lagoutanerie@gmail.com"
                                    className="underline underline-offset-4 hover:no-underline">lagoutanerie@gmail.com</a>.
                            </p>
                        </div>
                        <div>
                            ...
                            <p>Pour en savoir plus sur vos droits : <a href="https://www.cnil.fr/" target="_blank"
                                                                       rel="noopener noreferrer"
                                                                       className="underline underline-offset-4 hover:no-underline">www.cnil.fr</a>.
                            </p>
                        </div>
